...
- Continuously records every sticker Kick exposes in the open picker, including locked metadata, with a three-row one-click favorites shelf, portable removals, custom groups, and full JSON export/import from settings.
