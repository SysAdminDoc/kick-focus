...
- Continuously records every sticker Kick exposes in the open picker, including locked metadata, with portable favorites, removals, custom groups, and full JSON export/import from settings.
